...
namespace SZYJ.Stroke.Web.Menus
{
    public class StrokeMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public StrokeMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<StrokeResource>>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("Stroke.Home", l["Menu:Home"], "/"));
