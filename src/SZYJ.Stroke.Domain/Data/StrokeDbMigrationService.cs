...
{
    public class StrokeDbMigrationService : ITransientDependency
    {
        public ILogger<StrokeDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IStrokeDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public StrokeDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IStrokeDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<StrokeDbMigrationService>.Instance;
        }
